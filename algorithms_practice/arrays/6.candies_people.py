...
the row after we reach the end) until we run out of candies.  The last person will receive 
...
1 <= num_people <= 1000
'''
from algorithms3.arrays import candies_people

candies = 7
num_people = 4
print(candies_people(candies,num_people))

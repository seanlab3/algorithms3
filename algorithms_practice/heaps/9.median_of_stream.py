...
from algorithms3.heaps import median_of_stream
a=[2,3,4]



medianf=median_of_stream.MedianFinder()
for i in a:
    medianf.addNum(i)

print(medianf.findMedian())

medianf2=median_of_stream.MedianFinder2()
for i in a:
    medianf2.add_num(i)

print(medianf2.find_median())
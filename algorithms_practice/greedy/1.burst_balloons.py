...
and hence the x-coordinates of start and end of the diameter suffice. Start is always smaller than end. There will
 be at most 104 balloons.
...
#
#     return count
from algorithms3.greedy import burst_balloons
a=[[10,16], [2,8], [1,6], [7,12]]
print(burst_balloons.min_arrows(a))

...
have the same total amount of candy.  (The total amount of candy a person has is the sum of the sizes of candy 
bars they have.)
...
from algorithms3.greedy import fair_candy_swap

A = [1,1]
B = [2,2]

print(fair_candy_swap(A,B))

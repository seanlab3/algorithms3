...
#     backtrack(target)
#     return result
from algorithms3.backtracking import combinations_sum_four,combinations_sum_four_v2,combinations_sum_four_v3
from itertools import combinations,permutations

nums = [1, 2, 3]
target = 4
print(combinations_sum_four(nums,target))

print(combinations_sum_four_v2(nums,target))

print(combinations_sum_four_v3(nums,target))

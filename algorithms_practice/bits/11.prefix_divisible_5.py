...
from algorithms3.bits import prefix_divisible,prefix_divisible_v2,prefix_divisible_v3

a=[0,1,1,1,1,1]
print(prefix_divisible(a))

print(prefix_divisible_v2(a))

# print(prefix_divisible_v3(a))
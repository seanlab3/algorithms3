...
of two strings. The longest uncommon subsequence is defined as the longest subsequence of one of 
...
# def longest_uncommon(a, b):
#     if a == b: return -1
#     return max(len(a), len(b))
from algorithms3.strings import longest_uncommon_seq
a="aba"
b="cdc"
print(longest_uncommon_seq.longest_uncommon(a,b))

...
#             current_line += width
#
#     return [length, current_line]
from algorithms3.strings import number_of_lines_to_write_string

widths = [10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10]
S = "abcdefghijklmnopqrstuvwxyz"

print(number_of_lines_to_write_string.number_of_lines(widths,S))

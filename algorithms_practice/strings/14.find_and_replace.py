...
from algorithms3.strings import find_and_replace

S = "abcd"
indexes = [0,2]
sources = ["a","cd"]
targets = ["eee","ffff"]
print(find_and_replace.find_replace(S,indexes,sources,targets))

print(find_and_replace.find_replace_v2(S,indexes,sources,targets))

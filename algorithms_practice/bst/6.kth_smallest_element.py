...
#     inorder(root)
#     return kth_smallest
from algorithms3.bst import bst_implementation,kth_smallest_element
node=bst_implementation.TreeNode(3)
node.left=bst_implementation.TreeNode(1)
node.right=bst_implementation.TreeNode(4)

node.left.right=bst_implementation.TreeNode(2)

print(kth_smallest_element.kth_smallest_bst(node,1))

...
from algorithms3.bst import delete_node,bst_implementation

node=bst_implementation.TreeNode(5)
node.left=bst_implementation.TreeNode(3)
node.right=bst_implementation.TreeNode(6)

node.left.left=bst_implementation.TreeNode(2)

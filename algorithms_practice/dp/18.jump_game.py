...
#     return dp[-1]
#
from algorithms3.dp import jump_game
a=[2,3,1,1,4]

print(jump_game.can_jump(a))

print(jump_game.can_jump_v2(a))


print(jump_game.can_jump_v3(a))
# XXX
#print(jump_game.can_jump_v4(a))

print(jump_game.can_jump_v5(a))
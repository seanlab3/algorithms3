...
#     return new_head
#
from algorithms3.linkedlist import add_two_numbers_II
class ListNode:
    def __init__(self, x):
        self.val = x
        self.next = None
...
result = ListNode(7)
result_tail = result
result_tail.next = ListNode(8)
result_tail = result_tail.next
result_tail.next = ListNode(9)
...
l6 = add_two_numbers_II.add_two_numbers_list(result, result2)
printList(l6)
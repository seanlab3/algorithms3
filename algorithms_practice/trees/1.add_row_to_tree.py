...
def print2D(root) :
    ...
    print2DUtil(root, 0)
from algorithms3.trees import add_row_to_tree

root=add_row_to_tree.RowNode(4)
root.left=add_row_to_tree.RowNode(2)
root.right=add_row_to_tree.RowNode(6)

root.left.left=add_row_to_tree.RowNode(3)
root.right.left=add_row_to_tree.RowNode(15)
v = 1
d = 2

a=add_row_to_tree.add_one_row(root,v,d)
print2D(a)
